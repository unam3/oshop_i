...
erikras/react-redux-universal-hot-example</a>
        ...
        <p>
          Стили по методу erikras натягиваются странным образом: если подключены
по рекомендованным альтернативным методам, запущен сервер и открываете страницу
с require стиля, то вбросится ошибка о попытке разбора файла стиля
require-hacker как .js. Если перейти по ссылке на странице к нужному разделу —
все обработается как надо.
        </p>
        <p>
